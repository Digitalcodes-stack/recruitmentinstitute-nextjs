...
export const CANONICAL_COURSE_CONFIGS: Record<string, {
  ...
  'entrepreneurship': {
    ...
    defaultShortDescription: 'Build. Launch. Acquire Clients. Deliver. Scale. From Zero to a Profitable Recruitment Agency — Complete blueprint, legal frameworks, client acquisition engines and hands-on founder mentoring.',
    defaultOverview: 'The premier business accelerator for ambitious entrepreneurs, recruitment consultants and staffing professionals looking to launch, monetize and scale a high-margin recruitment agency. From legal incorporation and B2B client acquisition engines to high-ticket fee negotiations, recruiter hiring and scaling past ₹1 Crore ARR.',
    defaultDuration: '8 Weeks to 6 Months',
    defaultDurationShort: '8 Wk - 6 Mo',
    ...
    defaultCurriculum: [
      {
        ...
        duration: 'Weeks 1–2',
        accent: '#D97706',
        description: 'Recruitment vs staffing vs RPO, high-margin niche selection (IT, BFSI, Healthcare, Executive) and defining an unfair value proposition.',
        learningObjectives: ['Select your profitable high-margin recruitment niche.', 'Structure pricing and revenue models (8.33% to 20%).'],
        details: ['Agency business models: Contingency vs Retained vs RPO', 'Selecting high-margin niches (Tech, BFSI, Healthcare)', 'Target client profiling and commercial rate card structuring'],
      ...
      },
      {
        ...
        duration: 'Weeks 3–4',
        accent: '#B45309',
        description: 'Sole Proprietorship, LLP or Pvt Ltd setup, GST, MSME, NDA, SLA agreements, replacement policies and commercial risk mitigation.',
        ...
        details: ['Sole Proprietorship, LLP or Pvt Ltd incorporation guidance', 'Drafting client service agreements (SLA) & replacement clauses', 'Setting up banking, invoicing and tax accounting'],
      ...
      },
      {
        ...
        duration: 'Weeks 5–6',
        accent: '#059669',
        description: 'Building lean tech stacks, multi-portal sourcing access, candidate database architecture and standard delivery SOPs.',
      ...
      },
      {
        ...
        duration: 'Weeks 7–10',
        accent: '#2563EB',
        description: 'LinkedIn prospecting, cold email sequences, HR head calling scripts, discovery meetings and closing commercial contracts.',
      ...
      {
        week: 'Phase 5',
        title: 'Recruiter Hiring, Scaling Operations & ₹1 Cr+ ARR Roadmap',
        duration: 'Weeks 11–16+',
        accent: '#7C3AED',
        description: 'Hiring freelance vs full-time recruiters, commission and incentive plans, KPI scorecards, working capital management and 12-month scaling.',
        learningObjectives: ['Hire and manage your first team of recruiters.', 'Design commission structures that drive monthly revenue past ₹1 Cr ARR.'],
        details: ['Hiring freelance and full-time recruiters', 'Recruiter incentive models and daily KPI scorecards', '12-month scaling roadmap: Solo recruiter to multi-member agency'],
        practicalActivity: 'Build your agency 12-month financial revenue and cash flow model.',
      },
    ],
    defaultLearningOutcomes: [
      'Incorporate and legally structure a high-margin recruitment consultancy in India.',
      'Deploy ready-to-use Master Services Agreements (MSAs), NDA terms and commercial rate cards.',
      ...
      'Deploy modern agency ATS infrastructure and candidate fulfillment SOPs.',
    ...
    defaultWhoShouldEnroll: [
      { role: 'Aspiring Recruitment Agency Founders', desc: 'Recruiters and HR professionals ready to launch their own independent staffing or consulting firm.' },
      { role: 'Solo & Freelance Recruiters', desc: 'Solo consultants aiming to transition into a structured, scalable multi-client agency.' },
      { role: 'Established Consultants & Agency Owners', desc: 'Agency founders seeking 1-to-1 mentoring, deal negotiation support and institutional scaling.' },
    ],
    defaultToolsCovered: [
      { category: 'Agency ATS & CRM', tools: ['Zoho Recruit', 'Ceipal', 'Recruit CRM', 'Loxo'] },
      { category: 'B2B Sales & Outreach', tools: ['Apollo.io', 'LinkedIn Sales Navigator', 'Hunter.io', 'Instantly'] },
      { category: 'Operations & Billing', tools: ['Zoho Books', 'DocuSign', 'GST Portal', 'Google Workspace'] },
    ],
    defaultCertificationDetails: {
      ...
      bullets: [
        ...
        'Ongoing agency founder mastermind community and weekly mentoring reviews.',
      ],
    },
    defaultFaqs: [
      { q: 'Which plan should I choose: Launch, Accelerator or Mastery?', a: 'Plan 2 (Accelerator) is our most popular and recommended program for most founders. It gives you 6 full months of weekly business reviews, 1-to-1 mentoring, commercial negotiation support, ATS implementation and hands-on handholding until you can independently operate your business. If you just need initial 8-week setup guidance, Plan 1 (Launch) is available. For high-growth founders wanting 12-month C-suite advisory and direct WhatsApp access, Plan 3 (Mastery) is the top choice.' },
      { q: 'Can I start a recruitment agency alongside my current job?', a: 'Yes. Many successful agency founders in our cohorts begin on a part-time basis during evenings and weekends. Once you close your first 2–3 corporate clients and build steady placement cash flows, you can smoothly transition full-time.' },
      { q: 'Are actual government filing fees included in the program fee?', a: 'No. Government incorporation and registration filing fees (e.g. MCA, Stamp Duty, GST, Trademark or MSME official fees) are paid directly to government portals or your CA and are separate.' },
      { q: 'Do you provide ready-to-use client contracts and legal agreements?', a: 'Yes! You receive our complete library of battle-tested Master Services Agreements (MSAs), fee schedules (8.33% to 20%), candidate replacement policy clauses, non-disclosure agreements (NDAs) and client invoice templates.' },
      { q: 'How long does it typically take to acquire the first paying client?', a: 'Founders who diligently implement our LinkedIn and cold email outbound workflows typically secure their first discovery meetings within Weeks 3–4 and close their first recruitment mandate within 6–8 weeks.' },
      { q: 'What kind of support is provided for fee negotiations?', a: 'In the Accelerator and Mastery tiers, our senior mentors review your corporate proposals, join deal prep calls and guide you through commercial fee negotiations to ensure you secure healthy margins (8.33% to 15%+) and fair credit terms.' },
    ],
    defaultLmsStructure: [
  ...
  'ai-for-recruitment': {
    ...
    defaultFaqs: [
      ...
      { q: 'Can I attend classes offline in Pune or is it only online?', a: 'Both! You can enroll in our Live Online cohort or attend in-person classroom masterclasses at our Pune center. Both modes include complete LMS access.' },
