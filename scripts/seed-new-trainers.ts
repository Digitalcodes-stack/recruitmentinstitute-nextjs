...
const newTrainers = [
  ...
  {
    name: 'Saurav Dey',
    email: 'saurav.dey@institute.com',
    phone: '9870001013',
    specialization: 'Head HR & People Management Professional | HR Strategy | Talent Acquisition | People & Culture',
    bio: 'Experienced HR professional with a strong background in People & Culture, HR Strategy, Talent Acquisition and HR Operations with 10+ years of senior-level HR leadership.',
    image: '/assets/images/trainers/saurav_dey.jpg',
    profileJson: {
      designation: 'Head HR & People Management Professional | HR Strategy | Talent Acquisition | People & Culture',
      companyEx: 'Head HR & People Management Professional | HR Strategy | Talent Acquisition | People & Culture',
      experienceYears: 10,
