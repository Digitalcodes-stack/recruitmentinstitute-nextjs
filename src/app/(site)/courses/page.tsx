...
const SLUG_TO_ROUTE: Record<string, string> = {
  ...
  'ai-and-future-skills':                 '/ai-for-recruitment',
  // legacy redirects
...
const COURSE_META: Record<string, {
  ...
  'ai-for-recruitment': {
    ...
    icon: '⚡',
    tags: ['4 Weeks', '16+ Hrs Live', 'AI Tool Stack'],
    highlight: 'JD to Joining Workflow',
    image: '/assets/images/courses/home14/3.jpg',
    duration: '4 Weeks',
    mode: 'Online Live & Pune Classroom',
    ctaText: 'Join Next Batch',
  },
      ...
      },
      {
        ...
        itemListElement: allCards.map((c, i) => ({
          ...
          item: {
            ...
            image: c.meta.image.startsWith('http') ? c.meta.image : `${BASE_URL}${c.meta.image}`,
            provider: {
              '@type': 'Organization',
            ...
            offers: {
              '@type': 'AggregateOffer',
              priceCurrency: 'INR',
              lowPrice: c.onlinePrice,
              highPrice: c.offlinePrice,
              offerCount: 2,
              availability: 'https://schema.org/InStock',
              url: `${BASE_URL}${c.route}`,
            },
