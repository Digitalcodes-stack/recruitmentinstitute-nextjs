    ...
    '@graph': [
      {
        ...
        description:
          course.description ||
          'Master full lifecycle recruitment with our End-to-End Recruitment Training Course in India. Practical candidate sourcing, Boolean search, ATS tools, and interview training.',
        url: courseUrl,
        image: ogImage,
        courseCode: SLUG,
        educationalCredentialAwarded: 'Certified Recruitment Specialist',
        provider: {
        ...
        hasCourseInstance: [
          {
            '@type': 'CourseInstance',
            courseMode: 'Online',
            courseWorkload: course.duration || '6 Weeks',
            offers: {
              '@type': 'Offer',
              price: onlinePrice,
              priceCurrency: 'INR',
