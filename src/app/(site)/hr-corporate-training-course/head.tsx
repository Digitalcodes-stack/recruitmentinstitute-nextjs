export default function Head() {
  const base = 'https://recruitmentinstitute.in'
  return (
    <>
      ...
      <meta
        ...
        content="Customized HR training for teams and organizations focused on practical hiring and talent acquisition workflows."
      />
      <meta property="og:url" content={`${base}/hr-corporate-training-course`} />
      <meta property="og:type" content="website" />
      <meta name="twitter:card" content="summary_large_image" />
      <meta name="twitter:title" content="HR Corporate Training Course in Pune" />
      <meta
