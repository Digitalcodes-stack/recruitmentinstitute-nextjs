    ...
    '@graph': [
      {
        ...
        description:
          course.description ||
          'Customized HR corporate training courses for talent acquisition departments and enterprise hiring teams across India. Candidate sourcing, STAR interview mastery, and recruitment process audits.',
        url: courseUrl,
        image: ogImage,
        courseCode: SLUG,
        educationalCredentialAwarded: 'Certified Corporate Recruitment Professional / Team Certification',
        provider: {
        ...
        hasCourseInstance: [
          ...
          },
          {
            ...
            location: {
              '@type': 'Place',
              name: 'Corporate On-Premises / Recruitment Institute Campus',
              address: {
                '@type': 'PostalAddress',
