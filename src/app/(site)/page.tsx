...
export const metadata: Metadata = {
  title: {
    absolute: 'Recruitment Training in India | Online & Classroom Courses | Recruitment Institute',
  },
  description:
    'Master recruitment, talent acquisition, sourcing, ATS, & AI hiring with India\'s #1 recruitment training institute. Online & classroom courses with 100% career support.',
  keywords: [
  ...
  openGraph: {
    title: 'Recruitment Training in India | Online & Classroom Courses | Recruitment Institute',
    description:
      'Master recruitment, talent acquisition, sourcing, ATS, & AI hiring with India\'s #1 recruitment training institute. Online & classroom courses with 100% career support.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Recruitment Training in India - Recruitment Institute',
      },
    ],
  },
  twitter: {
...
export default async function Page() {
  ...
  const stats = [
    ...
    { icon: 'award' as const, value: '25+ Yrs', label: 'Industry Expertise', iconBg: '#FFFBEB', iconColor: '#D97706' },
